...
// For Noble Sacrifice. Runs at the top of every cycle, *before* the guards: the guard that would end
// the run for a hurt character is the same floor this heals to, so the order is the whole point.
