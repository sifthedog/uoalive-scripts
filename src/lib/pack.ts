...
// A lower bound: an unopened container reports `contents: undefined`.
//
// Recursion goes through the second parameter rather than the exported call, because a plain item
// has no `contents` and passing undefined into a defaulted parameter would restart at the backpack
// forever.
