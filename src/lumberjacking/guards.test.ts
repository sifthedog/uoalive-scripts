...
describe('stopReason', () => {
  ...
  // A max of 0 makes `weight > weightMax - 40` true for every character in the game. It stopped a
  // live mining run on cycle one, at a weight comfortably inside the limit it claimed to exceed.
