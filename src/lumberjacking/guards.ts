...
// Every step is checked before it is taken, so this only trips if something else moved the character
// - a teleporter, a boat, a GM - or if the run started outside the box.
