// GENERATED by scripts/patch-types.mjs - edit that, not this.
...
declare module "ItemSchema" {
    /** Not shipped in the client's typings - real shape unknown */
    export type VendorItem = any;
}

type ScriptConfig = import("config/types").ScriptConfig;
type Spells = import("enums").Spells;
declare const Spells: typeof import("enums").Spells;
type Skills = import("enums").Skills;
declare const Skills: typeof import("enums").Skills;
type Layers = import("enums").Layers;
declare const Layers: typeof import("enums").Layers;
type Directions = import("enums").Directions;
declare const Directions: typeof import("enums").Directions;
type SkillLock = import("enums").SkillLock;
declare const SkillLock: typeof import("enums").SkillLock;
type Notorieties = import("enums").Notorieties;
declare const Notorieties: typeof import("enums").Notorieties;
type BuffDebuffs = import("enums").BuffDebuffs;
declare const BuffDebuffs: typeof import("enums").BuffDebuffs;
type Abilities = import("enums").Abilities;
declare const Abilities: typeof import("enums").Abilities;
type SearchEntityOptions = import("enums").SearchEntityOptions;
declare const SearchEntityOptions: typeof import("enums").SearchEntityOptions;
type SearchEntityRangeOptions = import("enums").SearchEntityRangeOptions;
declare const SearchEntityRangeOptions: typeof import("enums").SearchEntityRangeOptions;
type SearchEntityTypeOptions = import("enums").SearchEntityTypeOptions;
declare const SearchEntityTypeOptions: typeof import("enums").SearchEntityTypeOptions;
type Virtues = import("enums").Virtues;
declare const Virtues: typeof import("enums").Virtues;
type Constant = import("enums").Constant;
declare const Constant: typeof import("enums").Constant;
type Client = import("Client").Client;
declare const Client: typeof import("Client").Client;
type Entity = import("Entity").Entity;
declare const Entity: typeof import("Entity").Entity;
type Mobile = import("Mobile").Mobile;
declare const Mobile: typeof import("Mobile").Mobile;
type Player = import("Player").Player;
declare const Player: typeof import("Player").Player;
type Item = import("Item").Item;
declare const Item: typeof import("Item").Item;
type Gump = import("Gump").Gump;
declare const Gump: typeof import("Gump").Gump;
type Journal = import("Journal").Journal;
declare const Journal: typeof import("Journal").Journal;
type Target = import("Target").Target;
declare const Target: typeof import("Target").Target;
type IgnoreList = import("IgnoreList").IgnoreList;
declare const IgnoreList: typeof import("IgnoreList").IgnoreList;
type PopupMenu = import("PopupMenu").PopupMenu;
declare const PopupMenu: typeof import("PopupMenu").PopupMenu;
type Prompt = import("Prompt").Prompt;
declare const Prompt: typeof import("Prompt").Prompt;
type WorldMap = import("WorldMap").WorldMap;
declare const WorldMap: typeof import("WorldMap").WorldMap;
...
declare function ScriptConfig(config: ScriptConfig): void;
/**
