...
from carpentry.config import (BANDS, BATCH_SIZE, BOX, BOX_PRESS_POLL, BOX_PRESS_TIMEOUT, BOX_TAKE,
                              ...
                              CRAFT_POLL, CRAFT_TIMEOUT, CRAFT_TITLE, CRAFT_TITLE_FRAGMENTS,
                              CRAFT_TITLE_TEXT, DATA_PATH, DEED_GRAPHICS, DUMP_AT, FETCH_POLL,
                              FETCH_TIMEOUT, GUMP_POLL, GUMP_TIMEOUT, HEARTBEAT_EVERY,
