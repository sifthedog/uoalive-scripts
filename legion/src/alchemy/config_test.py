...
class BandsTest(unittest.TestCase):
    def test_the_rows_hand_over_on_the_exclusive_edge(self):
        ...
        self.assertEqual(band_for(BANDS, 44.9), "greater agility")
        self.assertEqual(band_for(BANDS, 45.0), "greater strength")
        self.assertEqual(band_for(BANDS, 54.9), "greater strength")
        self.assertEqual(band_for(BANDS, 55.0), "greater poison")
        self.assertEqual(band_for(BANDS, 74.9), "greater poison")
        self.assertEqual(band_for(BANDS, 75.0), "greater cure")
        self.assertEqual(band_for(BANDS, 89.9), "greater cure")
